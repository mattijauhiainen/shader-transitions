...
// Fades the 3D shading in/out across curl so the flat-grid bookends match
// the resting halftone the neighbors leave behind.
...
void main() {
    ...
    // Premultiplied alpha — globe.ts uses blendFunc(ONE, ONE_MINUS_SRC_ALPHA).
